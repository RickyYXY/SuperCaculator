            ...
            else
            {
                ...
                else
                {
                    switch (comboBox2.Text)
                    {
                        ...
                        case "瓦特": label1.Text = "千瓦  " + num / 1000; break;
                        ...
                        case "大气压": label1.Text = "千帕  " + num * 101.325 + "毫米汞柱  " + num * 760; break;
                        case "千帕": label1.Text = "大气压  " + num / 101.325 + "毫米汞柱  " + (num / 101.35) * 760; break;
                        case "毫米汞柱": label1.Text = "千帕  " + (num / 760) * 101.35 + "大气压  " + num / 760; break;

                        case "度": label1.Text = "弧度  " + num * 3.1415 / 180 + "百分度  " + num * 760; break;
                        case "弧度": label1.Text = "度  " + num * 180 / 3.1415 + "百分度  " + (num / 101.35) * 760; break;
                        case "百分度": label1.Text = "度  " + num * 0.9 + "弧度  " + num * 0.9 * 3.1415 / 180; break;
                    }
                }
            }
        }
